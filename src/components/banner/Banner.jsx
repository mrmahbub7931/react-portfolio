        ...
        <>
            <section className="bg-secondary relative pt-[140px] pb-[125px]">
                    ...
                    <div className="grid grid-cols-1 2xl:-mx-4">
                        <div className="xl:pt-12">
                            ...
                            <h2 className="font-Syne text-black-800 font-bold text-[80px] lg:text-[100px] xl:text-[120px] 2xl:text-[140px] leading-[64px] lg:leading-[80px] xl:leading-[90px] 2xl:leading-[110px] mb-[20px]">
                                Rahman</h2>
                            <p className="font-Syne text-black-700 font-bold text-lg md:text-xl xl:text-2xl leading-tight mb-[30px]">Software
                                Engineer |
                            ...
                            <div className="flex flex-wrap items-center" data-aos="fade-right" data-aos-delay="1400">
                                <div className="flex flex-wrap items-center">
                                    <span className="font-Syne text-black-800 font-bold text-[44px] leading-none">
                                        <span className="counterr">1.2</span>k+</span>
                                ...
                                <div className="mt-5 sm:mt-0">
                                    <ul className="flex flex-wrap gap-x-4 items-center">
                                        ...
                                        <li><a href="https://www.linkedin.com/in/profile-mahbub/" target="_blank" className="text-black-800 hover:text-orange"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li><a href="https://github.com/mrmahbub7931" target="_blank" className="text-black-800 hover:text-orange"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="hidden md:block">
                    <img className="absolute top-0 right-0 md:max-w-[420px] lg:max-w-[570px] xl:max-w-[700px] 2xl:max-w-[initial]" src={profile} alt="" />
                    ...
                    <a href="contact.html">
                        <svg className="absolute bottom-[200px] lg:bottom-[80px] xl:bottom-[80px] right-[40px] lg:right-[150px] xl:right-[150px]" width="180" height="180" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g className="animate-spin origin-center">
                                ...
                                <path d="M157.631 90C157.631 127.352 127.352 157.632 89.9995 157.632C52.6476 157.632 22.3678 127.352 22.3678 90C22.3678 52.6481 52.6476 22.3683 89.9995 22.3683C127.352 22.3683 157.631 52.6481 157.631 90Z" fill="#080808" stroke="#FFB646" strokeWidth="2.08333" strokeMiterlimit="10" />
